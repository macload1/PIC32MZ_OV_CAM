...
bool _DRV_I2C0_MasterStop(void);
...
void DRV_I2C0_Initialize(void)
{
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C3_MASTER, INT_PRIORITY_LEVEL1);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_I2C3_MASTER, INT_SUBPRIORITY_LEVEL0);

    /* Initialize fault interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_I2C_3_BUS);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_I2C_3_BUS);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C3_BUS, INT_PRIORITY_LEVEL1);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_I2C3_BUS, INT_SUBPRIORITY_LEVEL0);
            ...
            */
                        ...
                        (!PLIB_I2C_TransmitterByteWasAcknowledged (I2C_ID_3)) ) )
            {
                ...
                else
                {
                    ...
                    {
                        /* Give an indication to the higher layer upon successful transmission */
                        i2c0ClientObj.callback(DRV_I2C_BUFFER_EVENT_COMPLETE, 
                                                            (DRV_I2C_BUFFER_HANDLE) lBufferObj0, 0x00);
                    }
                }
            }
